...
{
    public partial class ResidentRollCallYearlySummaryByMonth : Form
    {
        ...
        public ResidentRollCallYearlySummaryByMonth(List<ResidentRollCall> residentCalls, MDIMainForm mdiForm)
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            try
            {
                ...
                RollCallSummaryCalculatorBase rcsb = new RollCallYearlySummaryOverallCalculatorByMonth(_residentCalls);
                rcsb.Calculate();
        ...
        {
            List< ResidentYearlyCallSummaryByMonth> newList= _residentYearlyCallSummarySummaryList.ConvertAll(y => y as ResidentYearlyCallSummaryByMonth).OrderBy(x=>x.MonthNumber).ToList();
            dgRollCallYearlySummary.DataSource = newList;
        ...
        private void dgRollCallYearlySummary_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                for (int i = 4; i < dgRollCallYearlySummary.Columns.Count; i++)
                {
                    ...
                    //else if (cell.Value == null || cell.Value.ToString() == "0")
                    //    cell.Value = "";
                }
            }
        }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            FileExportBase efb = new ResidentRollCallYearlySummaryByMonthFile(_mdiForm.Jarvis);
