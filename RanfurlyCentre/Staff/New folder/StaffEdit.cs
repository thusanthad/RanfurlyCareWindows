...
{
    public partial class StaffEdit_old : Form
    {
        protected Person _staff;
        //protected List<Doctor> _doctorList;

        public StaffEdit_old(Person staff )
        {
            InitializeComponent();
            _staff = staff;
        }
        ...
        private void PopulateStaff()
        {
            ...
            txtPhone.DataBindings.Add("Text", _staff, "Phone");
            txtEmail.DataBindings.Add("Text", _staff, "Email");
        }
        ...
        private bool ValidateInput()
        {
            ...
            if (txtFirstName.Text == string.Empty)
                ep.SetError(txtFirstName, "Type new doctor name");
