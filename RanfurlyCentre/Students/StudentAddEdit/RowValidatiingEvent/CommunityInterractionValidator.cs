...
{
    public class CommunityInterractionValidator : DatagridViewRowValidatorBase
    {        
        public CommunityInterractionValidator(object sender, DataGridViewCellCancelEventArgs ee) :base(sender,ee)
        {
            //Validate();
        }
